...
import { PlayersValidationParameter } from './pipes/players-validation-parameter.pipe';
...
export class PlayersController {
    ...
    async updatePlayer(
            ...
            @Param('_id', PlayersValidationParameter) _id: string
        ): Promise<void> {
    ...
    @Get('/:_id')
    async getOnePlayer(
        @Param('_id', PlayersValidationParameter) _id: string ): Promise<Player> {
        return await this.playersService.getOnePlayer(_id);
    }

    @Delete('/:_id')
    async deletePlayer(
        @Param('_id', PlayersValidationParameter) _id: string): Promise<void> {
